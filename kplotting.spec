...
Source0  : https://download.kde.org/stable/frameworks/5.99/kplotting-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/kplotting-5.99.0.tar.xz.sig
...
%prep
%setup -q -n kplotting-5.99.0
cd %{_builddir}/kplotting-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665417588
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Plotting.so.5.99.0
