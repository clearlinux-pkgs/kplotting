...
Source0  : https://download.kde.org/stable/frameworks/5.64/kplotting-5.64.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.64/kplotting-5.64.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573362242
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kplotting-5.64.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kplotting/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Plotting.so.5.64.0
