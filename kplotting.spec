...
Source0  : https://download.kde.org/stable/frameworks/6.5/kplotting-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/kplotting-6.5.0.tar.xz.sig
...
%setup -q -n kplotting-6.5.0
cd %{_builddir}/kplotting-6.5.0
pushd ..
cp -a kplotting-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723238180
mkdir -p clr-build
pushd clr-build
