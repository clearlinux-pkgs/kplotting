...
Source0  : https://download.kde.org/stable/frameworks/6.2/kplotting-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kplotting-6.2.0.tar.xz.sig
...
%setup -q -n kplotting-6.2.0
cd %{_builddir}/kplotting-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715626940
mkdir -p clr-build
pushd clr-build
