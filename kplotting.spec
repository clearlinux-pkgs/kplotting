...
Source0  : https://download.kde.org/stable/frameworks/5.56/kplotting-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/kplotting-5.56.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552144480
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Plotting.so.5.56.0
